<%@ Page Title="" Language="VB" MasterPageFile="~/Views/Admin/AdminMaster.master" AutoEventWireup="false" CodeFile="Laboration.aspx.vb" Inherits="Views_Admin_Laboration" %>
 ...
 <label runat="server" id="ErrMsg" class="text-danger"></label>  <br />
  ...
  <asp:Button ID="DeleteBtn" runat="server" Text="Delete" class="btn btn-danger" BackColor="Red" ForeColor="Black" />
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <h1>Laboratorian Detials</h1>
                        <asp:GridView ID="LaboratorianGV"  runat="server" CssClass="grid-view" AutoGenerateSelectButton="True" selectionMode="Single" Width="100%">
